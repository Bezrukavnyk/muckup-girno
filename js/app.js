 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".review__slider") && window.innerWidth < 998) new core(".review__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".single-hospital__slider")) new core(".single-hospital__slider", {
                modules: [ Pagination ],
                slidesPerView: 3,
                spaceBetween: 16,
                speed: 800,
            ...
            if (document.querySelector(".before-after__slider")) new core(".before-after__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (window.innerWidth > 1024.1) window.addEventListener("scroll", (e => {
        ...
        if (priceItem) priceItem.forEach((elem => {
            elem.addEventListener("click", (event => {
                elem.classList.toggle("_active");
            }), false);
        }));
        let file = document.querySelectorAll("[type='file']");
        if (file) file.forEach((elem => {
            elem.addEventListener("change", (e => {
                elem.nextElementSibling.querySelector(".my-current-file").innerHTML = e.target.files[0].name;
            }));
        }));
